...
public class WeaponPlatform extends NpcShip
{
    public WeaponPlatform(long objectID, final OwnerCard ownerCard, final WorldCard worldCard, final ShipCard shipCard, Faction faction,
    ...
    {
        super(objectID, ownerCard, worldCard, SpaceEntityType.WeaponPlatform, faction, FactionGroup.Group0,
