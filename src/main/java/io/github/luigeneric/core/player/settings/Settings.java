...
{
    private final UserSettings serverSavedUserSettings;
    /**
     * The usercontrols
     */
    private final InputBindings inputBindings;

    public Settings(final long userID)
    {
        this(new UserSettings(userID), InputBindings.create(userID), userID);
    }

    public Settings(final UserSettings userSettings, final InputBindings inputBindings, final long userID)
    {
        this.serverSavedUserSettings = userSettings;
        this.inputBindings = inputBindings;
        MDC.put("userID", String.valueOf(userID));
    }

    public UserSettings getServerSavedUserSettings()
    {
        return serverSavedUserSettings;
    }

    public List<InputBinding> getDefaultInputBindings()
    {
