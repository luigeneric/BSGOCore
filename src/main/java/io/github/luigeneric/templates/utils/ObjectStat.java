...
public enum ObjectStat
{
    ...
    {
        private static final Map<Short, ObjectStat> mappings = new HashMap<>();
    }

    private static Map<Short, ObjectStat> getMappings()
    {
        return MappingsHolder.mappings;
    }

    ObjectStat(final short value)
    {
        this.value = value;
        getMappings().put(value, this);
    }
    ObjectStat(final int i)
    {
        this((short) i);
    }

    public static ObjectStat forValue(final short value)
    {
